...
ALLOWED_CLIENT_SOURCES = [
    ...
    "mcp",
    "cli",
    # Add any extra clients here later!
]

# Allowed values for commit_analysis.analysis_type. Mirrors the CHECK constraint
# on codesherlock.commit_analysis (see db_scripts/table_commit_analysis.sql).
